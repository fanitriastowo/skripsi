...
<body>
	...
	<!-- Add Modal -->
	<form:form commandName="keaktifan" action="${pageContext.request.contextPath }/keaktifan/save" cssClass="addKeaktifanForm">
	...
	<!-- Update Modal -->
	<form:form commandName="keaktifan" action="${pageContext.request.contextPath }/keaktifan/update" cssClass="updateKeaktifanForm">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Hapus Data Keaktifan</h4>
				</div>
				<div class="modal-body">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(".addKeaktifanForm").validate({
			...
			messages : {
				jmlSiswa : {
					required : "Field Keaktifan tidak boleh kosong",
