...
<title>Halaman Kemampuan Guru</title>
...
<body>
			...
			<table class="table table-hovered table-bordered table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href='<spring:url value="/kemampuan_guru/prepare_update/${kemampuan.id }" />' class="btn btn-xs btn-primary triggerUpdate">
								<span class="glyphicon glyphicon-pencil"></span> Edit</a>
							<a href='<spring:url value="/kemampuan_guru/delete/${kemampuan.id }" />' class="btn btn-xs btn-danger triggerDelete">
	...
	<!-- Add Modal -->
	<form:form commandName="kemampuanGuru" action="${pageContext.request.contextPath }/kemampuan_guru/save" cssClass="addKemampuanGuruForm">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="modalLabel">Tambah Data Kemampuan Guru</h4>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<label for="txtAddKemampuanGuru" class="control-label">Kemampuan Guru:</label>
							<form:input path="kemampuan" id="txtAddKemampuanGuru" cssClass="form-control" placeholder="Type Kemampuan Guru" />
						</div>
						<div class="form-group">
	...
	<!-- Update Modal -->
	<form:form commandName="kemampuanGuru" action="${pageContext.request.contextPath }/kemampuan_guru/update" cssClass="updateKemampuanGuruForm">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="modalLabel">Update Data Kemampuan Guru</h4>
					</div>
					<div class="modal-body">
						<form:hidden path="id" id="txtUpdateLblId"/>
						<div class="form-group">
							<label for="txtUpdateKemampuanGuru" class="control-label">Kemampuan Guru:</label>
							<form:input path="kemampuan" id="txtUpdateKemampuanGuru" cssClass="form-control" placeholder="Type Kemampuan Guru" />
						</div>
						<div class="form-group">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Hapus Data Kemampuan Guru</h4>
				</div>
				<div class="modal-body">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(".addKemampuanGuruForm").validate({
			...
			messages : {
				kemampuan : {
					required : "Field Kemampuan Guru tidak boleh kosong",
		...
		$(".updateKemampuanGuruForm").validate({
			rules : {
				kemampuan : {
					required : true,
					minlength : 3
		...
		$('.triggerUpdate').click(function(e) {
			...
			$.getJSON(url, function(data) {
				...
				$('#txtUpdateKemampuanGuru').val(data.kemampuan);
