...
<body>
	...
	<!-- Add Modal -->
	<form:form commandName="kondisiKelas" action="${pageContext.request.contextPath }/kondisi_kelas/save">
	...
	<!-- Update Modal -->
	<form:form commandName="kondisiKelas" action="${pageContext.request.contextPath }/kondisi_kelas/update">
