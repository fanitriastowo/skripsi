...
<body>
	<div class="container">
		...
		<div class="table-responsive">
			<table class="table table-hovered table-bordered table-striped">
				...
				<tbody>
					<c:forEach items="${kondisiKelases }" var="kondisiKelas" varStatus="index">
					<tr>
						<td><c:out value="${index.count }" />. </td>
						<td><c:out value="${kondisiKelas.kondisi}" /> </td>
						<td><c:out value="${kondisiKelas.point }" /> </td>
						<td>
							<a href='<spring:url value="/kondisi_kelas/prepare_update/${kondisiKelas.id }" />' class="btn btn-xs btn-primary triggerUpdate">
								<span class="glyphicon glyphicon-pencil"></span> Edit</a>
							<a href='<spring:url value="/kondisi_kelas/delete/${kondisiKelas.id }" />' class="btn btn-xs btn-danger triggerDelete">
	...
	<!-- Add Modal -->
	<form:form commandName="kondisiKelas" action="${pageContext.request.contextPath }/kondisi_kelas/save" cssClass="addKondisiKelasForm">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="modalLabel">Tambah Data Kondisi Kelas</h4>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<label for="txtAddKondisi" class="control-label">Kondisi:</label>
							<form:input path="kondisi" id="txtAddKondisi" cssClass="form-control" placeholder="Kondisi Kelas" />
						</div>
						<div class="form-group">
	...
	<!-- Update Modal -->
	<form:form commandName="kondisiKelas" action="${pageContext.request.contextPath }/kondisi_kelas/update" cssClass="updateKondisiKelasForm">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="modalLabel">Update Data Kondisi Kelas</h4>
					</div>
					<div class="modal-body">
						<form:hidden path="id" id="txtUpdateLblId"/>
						<div class="form-group">
							<label for="txtUpdateKondisi" class="control-label">Kondisi:</label>
							<form:input path="kondisi" id="txtUpdateKondisi" cssClass="form-control" placeholder="Kondisi Kelas" />
						</div>
						<div class="form-group">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(".addKondisiKelasForm").validate({
			...
			messages : {
				kondisi : {
					required : "Field Kondisi Kelas tidak boleh kosong",
		...
		$(".updateKondisiKelasForm").validate({
			rules : {
				kondisi : {
					required : true,
					minlength : 3
