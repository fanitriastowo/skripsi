...
<body>
	...
	<!-- Add Modal -->
	<form:form commandName="kondisiSekolah" action="${pageContext.request.contextPath }/kondisi_sekolah/save" cssClass="addKondisiSekolahForm">
	...
	<!-- Update Modal -->
	<form:form commandName="kondisiSekolah" action="${pageContext.request.contextPath }/kondisi_sekolah/update" cssClass="updateKondisiSekolahForm">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(".addKondisiSekolahForm").validate({
			rules : {
				kondisi : {
					required : true,
					minlength : 3
			...
			messages : {
				kondisi : {
					required : "Field Kondisi Sekolah tidak boleh kosong",
		...
		$(".updateKondisiSekolahForm").validate({
			rules : {
				kondisi : {
					required : true,
					minlength : 3
