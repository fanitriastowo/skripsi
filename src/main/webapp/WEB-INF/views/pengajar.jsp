...
<body>
	...
	<!-- Add Modal -->
	<form:form commandName="pengajar" action="${pageContext.request.contextPath }/pengajar/save" cssClass="addPengajarForm">
	...
	<!-- Update Modal -->
	<form:form commandName="pengajar" action="${pageContext.request.contextPath }/pengajar/update" cssClass="updatePengajarForm">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(".addPengajarForm").validate({
			...
			messages : {
				kualitas : {
					required : "Field Kualitas Pengajar tidak boleh kosong",
