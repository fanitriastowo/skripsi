...
<title>Halaman Waktu Pembelajaran</title>
...
<body>
	<div class="container">
		...
		<h3>Tambah Waktu Pembelajaran</h3>
		...
		<div class="table-responsive">
			<table class="table table-hovered table-bordered table-striped">
				...
				<tbody>
					<c:forEach items="${waktuPembelajarans }" var="waktu" varStatus="index">
					<tr>
						<td><c:out value="${index.count }" />. </td>
						<td><c:out value="${waktu.waktu }" /> </td>
						<td><c:out value="${waktu.point }" /> </td>
						<td>
							<a href='<spring:url value="/waktu_pembelajaran/prepare_update/${waktu.id }" />' class="btn btn-xs btn-primary triggerUpdate">
								<span class="glyphicon glyphicon-pencil"></span> Edit</a>
							<a href='<spring:url value="/waktu_pembelajaran/delete/${waktu.id }" />' class="btn btn-xs btn-danger triggerDelete">
	...
	<!-- Add Modal -->
	<form:form commandName="waktuPembelajaran" action="${pageContext.request.contextPath }/waktu_pembelajaran/save" cssClass="addWaktuPembelajaranForm">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="modalLabel">Tambah Data Waktu Pembelajaran</h4>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<label for="txtAddWaktuPembelajaran" class="control-label">Waktu Pembelajaran:</label>
							<form:input path="waktu" cssClass="form-control" placeholder="Type Waktu Pembelajaran" />
						</div>
						<div class="form-group">
	...
	<!-- Update Modal -->
	<form:form commandName="waktuPembelajaran" action="${pageContext.request.contextPath }/waktu_pembelajaran/update" cssClass="updateWaktuPembelajaranForm">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<form:input path="waktu" id="txtUpdateWaktuPembelajaran" cssClass="form-control" placeholder="Type Waktu Pembelajaran" />
						</div>
						<div class="form-group">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Hapus Data Waktu Pembelajaran</h4>
				</div>
				<div class="modal-body">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(".addWaktuPembelajaranForm").validate({
			rules : {
				waktu : {
					required : true,
					minlength : 3
		...
		$(".updateWaktuPembelajaranForm").validate({
			rules : {
				waktu : {
					required : true,
					minlength : 3
		...
		$('.triggerUpdate').click(function(e) {
			...
			$.getJSON(url, function(data) {
				...
				$('#txtUpdateWaktuPembelajaran').val(data.waktu);
